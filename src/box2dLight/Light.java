...
public abstract class Light implements Disposable {
     ...
     * @param distance light distance (if applicable), soft shadow length is set
     * to distance * 0.1f
     ...
     * rotation angle is taken into account for the light offset and direction
     * calculations
     */
     ...
     * ignored and will not create any shadows for this light. By default is set
     * to {@code false}.
     */
